package com.itlight.new_flutter_inbrain;
...
public class FlutterInbrainPlugin implements FlutterPlugin, MethodCallHandler,ActivityAware {
    ...
    InBrainCallback callback = new InBrainCallback() {
        ...
        @Override
        public void surveysClosed(boolean surveysCompleted, List<InBrainSurveyReward> rewards) {
            // Implement the surveysClosed method here
        ...
        public void surveysClosedFromPage() {
            // Implement the surveysClosedFromPage method here
            List<String> list = new ArrayList<String>();
        ...
        public boolean didReceiveInBrainRewards(List<Reward> rewards) {
            // Implement the didReceiveInBrainRewards method here
            int total = 0;
